...
function App(){ return <BrowserRouter basename={import.meta.env.BASE_URL}><Routes><Route path="/" element={<Navigate to="/traditional" replace/>}/><Route path="/traditional" element={<Traditional/>}/><Route path="/modern" element={<Modern/>}/><Route path="*" element={<Navigate to="/traditional" replace/>}/></Routes></BrowserRouter>; }
